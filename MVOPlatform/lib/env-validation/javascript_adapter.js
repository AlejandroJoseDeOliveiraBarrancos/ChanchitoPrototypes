...
class EnvValidator {
    ...
    _findLuaPath() {
        ...
        if (fs.existsSync(path.join(parent, 'lib', 'env-validation', 'lua', 'env_validation.lua'))) {
            return path.join(parent, 'lib', 'env-validation', 'lua');
        }
    ...
    validate(schema, envVars = null) {
        ...
        if (resultObj.errors) {
            ...
            } else if (typeof resultObj.errors === 'object') {
                // Convert object to array
                errors = Object.values(resultObj.errors);
            }
        }
        ...
        // Ensure errors is always an array in the returned object
