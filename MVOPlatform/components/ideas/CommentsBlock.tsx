            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-text-secondary mb-3 whitespace-pre-wrap break-words">
                    {comment.content}
                  </p>
                  ...
                  <div className="flex items-center gap-4 flex-wrap">
                    ...
                    >
                      <ArrowUp
                        className={`w-4 h-4 ${comment.upvoted ? 'fill-current' : ''}`}
                      />
                    ...
                    >
                      <div className="flex gap-2">
                        <textarea
                          ...
                          onChange={e => {
                            setReplyText(prev =>
                              new Map(prev).set(comment.id, e.target.value)
                            )
                            // Auto-resize
                            if (e.target) {
